...
describe('e2e - latest', () => {
  ...
  it('average based on one observation: latest/DKK+EUR', async function () {
    ...
    it('average based on five observations: latest/DKK+EUR', async function () {
      const rates = {
        DKK: {
          '2025-02-20': 1.5564,
          '2025-02-21': 1.5591,
  ...
  it('missing currencies: latest/?observations=5 Not OK 404', async function () {
    await request(app)
      .get('/api/v1/latest/?observations=5')
      .expect(404)
